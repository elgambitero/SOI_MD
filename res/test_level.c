...
const Board test_level = {
    {
     ...
     GRI, GBI, GGI, GNI, GYI, GWI, BOB, NET, NET, BOR, NET,   0,   0,   0,   0,   0,   0,  GLC, BDB,
     RDK,   0,   0, GNI,   0,   0, BOB, NET, BOR, BOR, BOR,   0,   0,   0,   0,   0, BOG, BDR,   0,
      GP, THN,   0,   0,   0,   0, BOB, NET,   0, BOR, NET,   0,   0, BFG, GLC, GLC,   0,   0,   0,
